Vue.component("grad", {
  ...
  <svg viewBox="0 0 200 100" width="200" height="100" ref="canv">
    <defs>
      ...
      <linearGradient id="hsv2"  x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse" spreadMethod="repeat">
        <stop offset="0%" :stop-color="sStop[0]" />
        <stop offset="100%" :stop-color="sStop[1]"/>
      </linearGradient>
      <linearGradient id="hsv3"  x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse" spreadMethod="repeat">
